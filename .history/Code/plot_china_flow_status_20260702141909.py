...
def main():
    ...
    MOSAIC_TIF = mosaic_dir / f"china_flow_status_factor33_{latest_run.name}.tif"
    MOSAIC_PNG = mosaic_dir / f"china_flow_status_factor33_{latest_run.name}.png"

    print(f"Merging {len(tile_paths)} tiles from {latest_run.name}")
