...
"""Aggregate global JRC seasonality tiles into flow-status tiles."""
...
PLOT_SCRIPT = PROJECT_ROOT / "Code" / "visualization" / "create_global_flow_status_mosaic.py"

FACTOR = 33
WATER_RATIO_THRESHOLD = 0.05
USE_CONNECTIVITY = True
MIN_CONNECTED_WATER_CELLS = 10
